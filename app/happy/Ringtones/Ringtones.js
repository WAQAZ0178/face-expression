...
import {ringtoneslibrary} from './Data';
...
export default function Ringtones() {
    ...
    const onPressNext = () => {
        setTimestamp(0);
        setSelectedMusic(
            ringtoneslibrary[(selectedMusicIndex + 1) % ringtoneslibrary.length],
        );
    ...
    return (
        <ImageBackground
            ...
            source = { require ('../../assets/ringtones.jpg') }
        >
